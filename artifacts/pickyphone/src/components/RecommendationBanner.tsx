  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
        <div className="w-24 h-32 md:w-32 md:h-40 shrink-0 bg-background rounded-xl p-2 border border-border shadow-inner flex items-center justify-center">
           <img src={phone.imageUrl} alt={phone.name} className="w-full h-full object-contain drop-shadow-xl" />
        </div>
        ...
        <div className="shrink-0 flex flex-col items-center md:items-end">
          <span className="text-3xl font-light">${phone.price}</span>
        </div>
      </div>
    </motion.div>
  );
